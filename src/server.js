...
const customerPortalRoutes = require('./modules/customer_portal/customer_portal.routes');
const paymentRoutes   = require('./modules/payments/payments.routes');
const { router: erpRoutes } = require('./modules/erp_integration/erp.routes');
const exhibitionRoutes  = require('./modules/exhibitions/exhibitions.routes');
...
const importRoutes       = require('./modules/import_engine/import.routes');
const bulkImportRoutes   = require('./modules/import_engine/bulk_import.routes');
...
const mediaRoutes          = require('./modules/products/media.routes');
