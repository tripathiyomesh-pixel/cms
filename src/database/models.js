...
const Product = sequelize.define('Product', {
  ...
  metal_type:        { type: DataTypes.ENUM('gold','silver','platinum','rose_gold','white_gold','palladium'), allowNull: true, defaultValue: null },
  purity:            { type: DataTypes.ENUM('24K','22K','18K','14K','950','925','other'), allowNull: true, defaultValue: null },
  gross_weight:      { type: DataTypes.DECIMAL(10,3), allowNull: true, defaultValue: null },
  ...
  final_price:       { type: DataTypes.DECIMAL(15,2), allowNull: false, defaultValue: 0.00 },
  ...
  is_featured:       { type: DataTypes.BOOLEAN, defaultValue: false },
  sort_order:        { type: DataTypes.INTEGER, defaultValue: 0 },
  inventory_type:    { type: DataTypes.ENUM('JEWELLERY','NATURAL_DIAMOND','LAB_GROWN_DIAMOND','GEMSTONE','PEARL','MOUNTING','CUSTOM_DESIGN','PARCEL'), defaultValue: 'JEWELLERY' },
  inventory_mode:    { type: DataTypes.ENUM('IN_HOUSE','MEMO','SUPPLIER','MADE_TO_ORDER','VIRTUAL'), defaultValue: 'IN_HOUSE' },
  inventory_number:  { type: DataTypes.STRING(50) },
