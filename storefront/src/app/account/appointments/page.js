  ...
  return (
    <div>
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:8 }}>
        <h1 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:32, fontWeight:300, color:'var(--color-text)' }}>My Appointments</h1>
        <Link href="/appointment" style={{ fontSize:11, fontWeight:500, letterSpacing:'0.12em', textTransform:'uppercase', color:'var(--color-text)', borderBottom:'1px solid #1a1a1a', paddingBottom:1 }}>Book new →</Link>
      </div>
      ...
      {items.length === 0 ? (
        <div style={{ textAlign:'center', padding:'60px 0' }}>
          ...
          <p style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:24, fontWeight:300, color:'var(--color-text)', marginBottom:8 }}>No appointments yet</p>
          <Link href="/appointment" style={{ fontSize:11, fontWeight:500, letterSpacing:'0.15em', textTransform:'uppercase', color:'var(--color-text)', borderBottom:'1px solid #1a1a1a', paddingBottom:2 }}>Book a consultation →</Link>
        </div>
      ) : (
            ...
            <div key={apt.id} style={{ padding:'20px 24px', border:'1px solid #e5e0d8', background:'#fff', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
              <div>
                <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:8 }}>
                  <p style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:18, fontWeight:400, color:'var(--color-text)' }}>{apt.type||'Boutique Consultation'}</p>
