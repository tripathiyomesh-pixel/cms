  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ background: 'var(--color-text)', padding: '100px 40px 80px', textAlign: 'center' }}>
        <p style={{ fontSize: 11, letterSpacing: '0.25em', textTransform: 'uppercase', color: 'var(--color-accent)', marginBottom: 16 }}>Est. 1964</p>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '80px 40px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
        <div>
          <p style={{ fontSize: 11, letterSpacing: '0.25em', textTransform: 'uppercase', color: 'var(--color-accent)', marginBottom: 16 }}>Our Heritage</p>
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(32px,4vw,52px)', fontWeight: 300, color: 'var(--color-text)', lineHeight: 1.1, marginBottom: 24 }}>
          ...
          <Link href="/boutiques" style={{ fontSize: 11, fontWeight: 500, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--color-text)', borderBottom: '1px solid #1a1a1a', paddingBottom: 2 }}>
            Visit our boutiques →
          </Link>
        </div>
      ...
      {/* Stats */}
      <div style={{ background: 'var(--color-text)', padding: '60px 40px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 40, textAlign: 'center' }}>
          {[
            ...
            <div key={s.label}>
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 48, fontWeight: 300, color: 'var(--color-accent)', lineHeight: 1, marginBottom: 8 }}>{s.num}</p>
      ...
      <div style={{ padding: '80px 40px', textAlign: 'center', background: '#faf8f3' }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(28px,4vw,48px)', fontWeight: 300, color: 'var(--color-text)', marginBottom: 16 }}>
        ...
        <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="/boutiques" style={{ background: 'var(--color-text)', color: '#fff', padding: '14px 36px', textDecoration: 'none', fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase' }}>
            Find a Boutique
          </Link>
