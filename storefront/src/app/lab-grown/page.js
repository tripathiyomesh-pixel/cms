    ...
    <div style={{ fontFamily:"'Inter', system-ui, sans-serif" }}>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="font-cormorant text-5xl font-light mb-6" style={{ color:'var(--color-text)' }}>
              What are Lab Grown Diamonds?
            </h2>
            <div style={{ width:40, height:1, background:'var(--color-accent)', marginBottom:28 }}/>
            <div className="space-y-4" style={{ fontSize:13, color:'#6b6b6b', lineHeight:1.9 }}>
              ...
              <p>They are <strong style={{ color:'var(--color-text)' }}>chemically, physically, and optically identical</strong> to mined diamonds — the only difference is their origin.</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={f.title} className="p-5 border" style={{ borderColor:'#e5e0d8' }}>
                <h3 className="font-medium mb-2" style={{ fontSize:12, color:'var(--color-text)', letterSpacing:'0.05em' }}>{f.title}</h3>
      ...
      <section className="py-16" style={{ background:'var(--color-bg)' }}>
        <div className="max-w-screen-xl mx-auto px-6 lg:px-12">
          ...
          <h2 className="font-cormorant text-4xl font-light text-center mb-12" style={{ color:'var(--color-text)' }}>Lab-Diamond Jewellery</h2>
      ...
      <section className="py-12 bg-white border-t" style={{ borderColor:'#e5e0d8' }}>
        <div className="max-w-screen-xl mx-auto px-6 lg:px-12 flex flex-col sm:flex-row items-center justify-between gap-6">
          <p className="text-sm" style={{ color:'#6b6b6b', maxWidth:500 }}>
            <strong style={{ color:'var(--color-text)' }}>Important:</strong> Lab Grown jewellery and natural jewellery are shown on separate pages. 
            Our lab-grown pieces are clearly marked and never mixed with natural collections.
          </p>
          <Link href="/jewellery" className="btn-tejori whitespace-nowrap" style={{ background:'transparent', color:'var(--color-text)', border:'1px solid #1a1a1a', padding:'12px 28px' }}>
