...
const MODULES = [
  ...
  { id:"diamonds",      icon:"ti-hexagon",          name:"Diamond Module",      phase:"Inventory",  total:11, done:4  },
  { id:"gemstones",     icon:"ti-oval",             name:"Gemstone Module",     phase:"Inventory",  total:4,  done:2  },
  { id:"pearls",        icon:"ti-circle",           name:"Pearl Module",        phase:"Inventory",  total:3,  done:2  },
  { id:"mountings",     icon:"ti-ring",             name:"Mounting Module",     phase:"Inventory",  total:5,  done:2  },
  { id:"certs",         icon:"ti-certificate",      name:"Certificate Engine",  phase:"Trust",      total:5,  done:3  },
  { id:"suppliers",     icon:"ti-building-store",   name:"Supplier & Memo",     phase:"Operations", total:5,  done:2  },
  { id:"manufacturing", icon:"ti-tools",            name:"Manufacturing",       phase:"Operations", total:8,  done:3  },
